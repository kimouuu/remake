                    ...
                    <div class="container">
                        ...
                        <div class="header-top-right">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown" style="min-width: 11rem;">
                                    <li>
                        ...
                        <ul>
                            ...
                            <li
                                ...
                                <a href="{{ route('member.dashboard') }}" class='menu-link'>
                                    <span><i class="bi bi-grid-fill" style="color: orange;"></i> Beranda</span>
                                </a>
                            </li>
...
@yield('content-non-member')
    ...
    <script src="{{ asset('mazer/assets/static/js/app.js') }}"></script>
    <script src="{{ asset('mazer/assets/static/js/components.js') }}"></script>
