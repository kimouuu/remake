                ...
                <div id="selectOptions" style="display:none;">
                    ...
                    <div class="option-container">
                        <div class="input-group mb-3">
                            {{-- <input type="hidden" name="user_document_type_id" value="{{ $documentTypeId }}"> --}}
                            <input type="text" name="select_options[]" class="form-control" placeholder="Masukkan opsi" required>
